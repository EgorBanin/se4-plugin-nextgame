<?php $this->headLink()->appendStylesheet('application/nextgame/externals/styles/main.css', 'screen') ?>
            ...
            <div class="app">
              <div class="wrapper">
                ...
                <div class="info">
                  ...
                  <div class="actions">
                    <a href="<?php echo $this->url(array('module' => 'nextgame', 'controller' => 'user-apps', 'action' => 'remove', 'app' => $app['id']), 'default') ?>">remove</a>
                  </div>
                </div>
              </div>
            </div>
